      ...
      <main className="max-w-[1000px] lg:min-w-[920px] mx-auto mt-20 p-6 sm:p-10">
        ...
        <section className="text-[18px] leading-[30px] md:leading-[40px] space-y-6 font-medium">
          ...
          <p className="">
            ...
            the Osiso Bookings platform, including our website, any mobile
            ...
            is incorporated herein by reference). If you do not agree to these
          ...
          <div className="">
            ...
            <p>
              ...
              procedures that may be published from time to time on the Service
          ...
          <div className="">
            ...
            <p>
              ...
              without notice to you. We will not be liable to you or to any
          ...
          <div className="">
            ...
            <p>
              <ul className="list-disc list-inside">
                <li>
                  Registration: To access and use certain features of the
                  Service, you must register for an account ("Account"). When
                  you register for an Account, you agree to provide true,
                ...
                <li>
                  ...
                  immediately notify Osiso Bookings of any unauthorized use, or
                  suspected unauthorized use of your Account or any other breach
                  of security. Osiso Bookings cannot and will not be liable for
                ...
                <li>
                  ...
                  different. By agreeing to these Terms, you represent and
                  warrant to us that you are of legal age to form a binding
                  contract.
                </li>
              </ul>
            </p>
          ...
          <div className="">
            ...
            <p>
              <ul className="list-disc list-inside">
                ...
                <li>
                  License to Osiso Bookings: By creating, uploading, or
                  otherwise submitting UGC to the Service, you grant Osiso
                  Bookings a worldwide, non-exclusive, royalty-free,
                  sublicensable, and transferable license to use, reproduce,
                  distribute, prepare derivative works of, display, and perform
                  the UGC in connection with the Service and Osiso Bookings'
                  (and its successors' and affiliates') business, including for
                  promoting and redistributing part or all of the Service. This
                  license is solely for the purpose of operating, developing,
                  providing, promoting, and improving the Service and
                  researching and developing new ones. This license continues
                  even if you stop using our Services (for example, for content
                  that has been shared publicly or with others who have not
                  deleted it).
                </li>
                <li>
                  Responsibility for UGC: You are solely responsible for your
                  UGC and the consequences of posting or publishing it. You
                  ...
                  <ul className="list-disc list-inside ml-6">
                    ...
                    <li>
                      ...
                      rights), rights of publicity or privacy, or any other
                      legal or moral rights;
                    </li>
                    <li>
                      Your UGC is not defamatory, libelous, obscene,
          ...
          <div className="">
            ...
            <p>
              ...
              prohibited by these Terms or by applicable law. You are
              responsible for all of your activity in connection with the
              Service. You shall not (and shall not permit any third party to):
              <ul className="list-disc list-inside">
                <li>
                ...
                <li>
                  Use the Service to harass, abuse, defame, or otherwise
            ...
            <p>
              ...
              <ul className="list-disc list-inside">
                ...
                <li>
                  ...
                  bill you through a payment account linked to your Account on
                  the Service. The processing of payments will be subject to the
                  terms, conditions, and privacy policies of the Payment
                  Processor in addition to these Terms. We are not responsible
                ...
                <li>
                  ...
                  recurring payment plan, you acknowledge that such Services
                  have an initial and recurring payment feature and you accept
                  responsibility for all recurring charges prior to
                  cancellation.
                </li>
                <li>
                  Subscription Cancellation:  You may cancel your Subscription
                  at any time; however, there are no refunds for cancellation
                  except as may be required by applicable law. If you cancel,
                  your subscription will remain active until the end of the
                  current billing cycle.
                </li>
                <li>
                  Refunds: Paid fees are non-refundable except as required by
                  law or as otherwise specifically stated herein.
                </li>
                <li>
                  Taxes: All fees are exclusive of applicable national,
                  provincial, state, local or other taxes ("Taxes"), unless
                  otherwise stated. You are responsible for all applicable
                  Taxes.
                </li>
              </ul>
            </p>
            ...
            <p>
              <ul className="list-disc list-inside">
                <li>
                  ...
                  (collectively, "Osiso Bookings IP") are owned by Osiso
                  Bookings or Osiso Bookings' licensors. Neither these Terms nor
                  your access to the Service transfers to you or any third party
                  any rights, title, or interest in or to such Osiso Bookings
                  IP, except for the limited access rights expressly set forth
                  herein. Osiso Bookings and its licensors reserve all rights
          ...
          <div className="">
            ...
            <p>
              ...
              services. You further acknowledge and agree that Osiso Bookings
              ...
              We encourage you to be aware when you leave the Service and to
          ...
          <div className="">
            ...
            <p>
              ...
              NON-INFRINGEMENT.
              <br />
              OSISO BOOKINGS DOES NOT WARRANT THAT: (A) THE SERVICE WILL BE
              ...
              AVAILABLE AT OR THROUGH THE SERVICE IS FREE OF VIRUSES OR OTHER
              HARMFUL COMPONENTS; OR (D) THE RESULTS OF USING THE SERVICE WILL
              MEET YOUR REQUIREMENTS. YOUR USE OF THE SERVICE IS SOLELY AT YOUR
              OWN RISK.
              <br />
          ...
          <div className="">
            ...
            <p>
              ...
              SHALL OSISO BOOKINGS, ITS AFFILIATES, DIRECTORS, EMPLOYEES,
              ...
              <br />
              UNDER NO CIRCUMSTANCES WILL OSISO BOOKINGS' TOTAL LIABILITY
              ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OR FROM THE USE
              OF OR INABILITY TO USE THE SERVICE EXCEED THE AMOUNTS YOU HAVE
              PAID TO OSISO BOOKINGS FOR USE OF THE SERVICE IN THE [E.G., THREE
              (3) MONTHS] PERIOD PRIOR TO THE EVENT GIVING RISE TO THE
              LIABILITY, OR, IF YOU HAVE NOT HAD ANY PAYMENT OBLIGATIONS TO
              OSISO BOOKINGS, ONE HUNDRED NIGERIAN NAIRA (NGN 100.00)
              <br />
              THE LIMITATIONS OF DAMAGES SET FORTH ABOVE ARE FUNDAMENTAL
              ELEMENTS OF THE BASIS OF THE BARGAIN BETWEEN OSISO BOOKINGS AND
              YOU.
            </p>
          </div>
          <div className="">
            ...
            <p>
              ...
              or your use of the Service, including, but not limited to, your
              User-Generated Content, any use of the Service's content,
          ...
          <div className="">
            ...
            <p>
              <ul className="list-disc list-inside">
                ...
                <li>
                  Termination by Osiso Bookings: We may suspend or terminate
                  your rights to use the Service (including your Account) at any
                  time for any reason at our sole discretion, including for any
                  use of the Service in violation of these Terms. Upon
                  termination of your rights under these Terms, your Account and
                  right to access and use the Service will terminate
                  immediately.
                </li>
                <li>
                  Effect of Termination: Upon termination, all provisions of
                  these Terms which by their nature should survive, will
          ...
          <div className="">
            ...
            <p>
              <ul className="list-disc list-inside">
                <li>
                  Governing Law: These Terms and any dispute or claim arising
                  out of, or related to them, their subject matter or their
                  formation (in each case, including non-contractual disputes or
                  claims) shall be governed by and construed in accordance with
                  the laws of the Federal Republic of Nigeria, without giving
                ...
                <li>
                  ...
                  <ul className="list-disc list-inside ml-6">
                    <li>
                      Option 1 (Negotiation/Mediation): You agree to first try
                      to resolve any dispute informally by contacting Osiso
                      Bookings at Info@osisobookings.com. If a dispute is not
                      resolved within 60 days of submission, you or Osiso
                      Bookings may bring a formal proceeding.
                    </li>
                    <li>
                      ...
                      Federation of Nigeria 2004. The number of arbitrators
                      shall be one. The seat, or legal place, of arbitration
                      shall be Lagos, Nigeria. The language to be used in the
                    ...
                    <li>
                      ...
                      any other relevant country. You waive any and all
