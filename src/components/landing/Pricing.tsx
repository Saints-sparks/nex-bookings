...
export default function Pricing() {
  ...
  return (
    <div className="w-full">
      <h2 className="text-2xl font-bold mb-4 text-[#6C35A7]">Pricing Packages</h2>
      <p className="font-medium text-[17px] md:text-[19px]">Select whichever package best suits your businesses needs</p>
